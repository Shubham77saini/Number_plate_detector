...
from tensorflow.keras.preprocessing.image import load_img, img_to_array # Load img and Img to array
...
def object_detection(path,filename):
    ...
    # data preprocessing
    image_arr_244 = img_to_array(image1)/255.0 # convert into array and get normalize output
    h,w,d = image.shape
